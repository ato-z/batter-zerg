...
--
-- Host: 39.106.227.225    Database: batter
-- ------------------------------------------------------
...
CREATE TABLE `az_goods` (
  ...
  `message` varchar(1024) DEFAULT NULL COMMENT '留言：期望交换意见',
...
CREATE TABLE `az_goods_cate` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(100) NOT NULL COMMENT '唯一的name',
...
CREATE TABLE `az_image` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `path` varchar(1024) NOT NULL COMMENT '文件保存路径',
  ...
  `color` char(6) DEFAULT NULL COMMENT '图片的均色色码，可用作图像懒加载',
  `from` tinyint(3) unsigned NOT NULL DEFAULT 0 COMMENT '图像来源 0本地 1对象存储服务器',
  `create_date` datetime NOT NULL DEFAULT current_timestamp(),
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=25 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='图片表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `az_menu` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `title` varchar(100) NOT NULL,
  `path` varchar(100) DEFAULT NULL COMMENT '如果存在二级菜单，path无效',
...
CREATE TABLE `az_menu_level` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `title` varchar(100) DEFAULT NULL COMMENT '路由名称',
  `level` tinyint(3) unsigned NOT NULL DEFAULT 8,
  `model` varchar(100) NOT NULL COMMENT '模块名例如 staff',
...
CREATE TABLE `az_staff_record_body` (
  ...
  `body` text NOT NULL COMMENT 'body 携带的参数'
...
CREATE TABLE `az_user` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `open_id` varchar(100) NOT NULL COMMENT '微信小程序openid',
  `union_id` varchar(100) DEFAULT NULL COMMENT '微信的唯一用户id，可能为空',
  ...
  `country` varchar(100) DEFAULT NULL COMMENT '区',
...
CREATE TABLE `az_user_address` (
  ...
  `city` varchar(100) DEFAULT NULL COMMENT '市',
  `country` varchar(100) DEFAULT NULL COMMENT '区',
  `detail` varchar(1024) NOT NULL COMMENT '详情地址',
...
-- Dump completed on 2023-02-07 13:08:50
